...
public class Box {
    ...
    public static void main(String[] args) {
        Box rect = new Box();
        System.out.println("Wywolanie funkcji buildBox ze "+"Współrzędnymi (25,25) i (50,50)");
        rect.buildBox(25,25,50,50);
        rect.printBox();

        System.out.println("\nWywolanie funkcji buildBox z "+"Punktami (10,10) i (20,20)");
        rect.buildBox(new Point(10,10),new Point(20,20));
        rect.printBox();

        System.out.println("\nWywolanie funkcji buildBox z "+"Punktem (10,10), szerokością 50 i z wysokością 50");
